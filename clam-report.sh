...
# sudo clamscan -ri "$DIR_TO_SCAN" &>"$LOG_FILE"
# sudo nice -n5 clamscan -ri / --exclude-dir=/sys/ &>"$LOG_FILE";

# Create and send report mail
...
# Delete log-file and directory of infected files
